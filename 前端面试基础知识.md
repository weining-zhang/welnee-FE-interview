...
- Web Worker，https://mp.weixin.qq.com/s/nRPTyel9mPP7SNeXEYLN3g
...
- **说说 babel 原理是什么？**，https://xz-fe-interview.gitbook.io/fe-interview/webpack#babel

  - 解析，通过 babylon 解析生成 AST
  - 转换，对 AST 进行遍历转译，生成新 AST
  - 生成，将新 AST 转成 ES5
